...
namespace ToDo_App
{
    ...
    class Program
    {
        ...
        public static void HomePage()
        {
            ...
            Console.WriteLine("*******************************************");
            Console.WriteLine("(1) Board Listelemek");// getBoard and printLine (from getBoard) methods cusers
        ...
        private static void moveCard()
        {
            ...
            if (_line is not null)
            {
                ...
                Console.WriteLine("Atanan Kişi : {0}", _users.users.Find(x => x.Id == _card.UserID).FullName);
